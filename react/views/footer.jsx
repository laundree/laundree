...
const Footer = () => <footer>
  <ul>
    <li>
      ...
      in <a href='https://en.wikipedia.org/wiki/Aarhus' target='_blank'>Aarhus, Denmark</a>
    </li>
    <li>
      <svg xmlns='http://www.w3.org/2000/svg'>
      ...
      details at the <a href='/contact'>Contact page</a>
    </li>
    <li>
      <svg xmlns='http://www.w3.org/2000/svg'>
      ...
      File an issue, create a pull-request, or fork us on <a href='https://github.com/laundree/laundree' target='_blank'>GitHub</a>
    </li>
    <li>
      <svg xmlns='http://www.w3.org/2000/svg'>
      ...
      Then feel free to donate via <a href='#' target='_blank'>PayPal</a>
    </li>
