...
config.facebook.appId = process.env.FACEBOOK_APP_ID || '1044245858966868'
config.facebook.appSecret = process.env.FACEBOOK_APP_SECRET || '394f0ef62fd8d104e110ba898afeeb4a'
...
config.codeClimate.repoToken = process.env.CODECLIMATE_REPO_TOKEN || ''
