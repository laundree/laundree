...
class TimetableWrapper extends React.Component<TimetableProps & {touring?: boolean, onStartTour: () => *}> {
  renderEmpty () {
        ...
        ? (
          <section>
            ...
            <div style={{paddingTop: '2em'}}>
              <button onClick={this.props.onStartTour} className={this.props.touring ? 'grey' : ''} disabled={this.props.touring}>
